/* -----------------------------------------------------------------------------
 *
 * @file LinearRegressionRandom.cpp
 *
 ...
 * point \f$ (\vec x, y) \f$ are generated likewise. The dependent variable
 * \f$ y \f$ is a normally distributed random variate with mean
 * \f$ \langle \vec c, \vec x \rangle \f$ and standard deviation \c stddev.
 */
template <class FormatPolicy>
class LinearRegressionRandom : public FormatPolicy {
